...
public class CreatecontactWithIntegration {
	...
	public void createOrg() throws IOException, InterruptedException 
	{
		...
		d.findElement(By.xpath("//img[@style='cursor:hand;cursor:pointer']")).click();
        wdu.switchtowindow(d, "id");
	/*	String mainId = d.getWindowHandle();
		...
		d.findElement(By.xpath("//input[@id='search_txt']")).sendKeys("prudvish");
		d.findElement(By.xpath("//a[text()='prudvish']")).click();
		wdu.switchtowindow(d, "mainId");
