package com.vtiger.genericrepository;
...

	{
		...
		public void implicitwait(WebDriver driver) {
			driver.manage().timeouts().implicitlyWait(Iconstants.explicitwaittime, TimeUnit.SECONDS);
		}
		/**
		...
		{
			WebDriverWait wait = new WebDriverWait(driver, Iconstants.implicitwaittime);
